...
\begin{tabular}{lcccccccc}
\toprule
 & \multicolumn{3}{c}{At detection position} & & \multicolumn{2}{c}{At inj.\ crossing (MS TP)} \\
\cmidrule(lr){2-4}\cmidrule(lr){6-7}
Window & PVI $\bar{\omega}$ & MS $\bar{\omega}$ & KS $p$ & &
         MS $\bar{\omega}$ & Inj.\ all $\bar{\omega}$ \\
\midrule
10 s  & 114° & \phantom{0}0.5° & $1.7\times10^{-44}$ & & 101° & 108° \\
30 s  & 130° & \phantom{0}3.9° & $1.1\times10^{-42}$ & & 128° & 128° \\
60 s  & 132° & \phantom{0}42°  & $4.1\times10^{-31}$ & & 132° & 132° \\
120 s & 134° & \phantom{0}83°  & $2.1\times10^{-13}$ & & 134° & 133° \\
\midrule
\multicolumn{8}{l}{\small $f_\pi$ (fraction $\omega>160^\circ$):
  PVI: 3\%/7\%/7\%/8\%;
  MS at detect: 0\%/0\%/0\%/2\%;
  MS at inj.\ crossing: 0\%/2\%/2\%/3\%} \\
\bottomrule
\end{tabular}
\end{table}
...
applications: current sheet crossing rates of $\sim$4/day correspond to
$\sim 6$-hour inter-event spacing, so the $\pm 30\s$ positioning error is
$< 0.01\%$ of the typical inter-event interval.
